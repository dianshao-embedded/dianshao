...
urlpatterns = [
    ...
    path('<int:project_id>/myimage/<int:myimage_id>/update_generate', views.update_generate, name='update_generate'),
    path('<int:project_id>/myimage/<int:myimage_id>/bitbake', views.myimage_bitbake, name='myimage_bitbake'),
    path('<int:project_id>/myimage/<int:myimage_id>/update_bitbake', views.myupdate_bitbake, name='myupdate_bitbake'),
